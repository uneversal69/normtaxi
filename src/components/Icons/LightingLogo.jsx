...
<g filter="url(#filter0_d_291_133)">
<rect x="10" y="10" width="48" height="48" rx="24" fill="white"/>
<rect x="11" y="11" width="46" height="46" rx="23" stroke="#FFD600" stroke-width="2"/>
</g>
<path d="M22 45.68H46V21.68H22V45.68Z" fill="url(#pattern0)"/>
<defs>
<filter id="filter0_d_291_133" x="-2" y="-2" width="72" height="72" filterUnits="userSpaceOnUse" color-interpolation-filters="sRGB">
